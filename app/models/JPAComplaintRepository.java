...
//    }
    ...
    //ward
    public CompletionStage<Stream<Complaint>> categoryWardList(String Category) {
        return supplyAsync(() -> wrap(em -> categoryWardList(em,Category)), executionContext);
    }
...
//    }
    ...
    //ward
    private Stream<Complaint> categoryWardList(EntityManager em,String Category) {
